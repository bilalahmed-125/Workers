...
public class PainterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = fb.collection("workers").whereEqualTo("profession","Painter");
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            images.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    int checkPermission = ContextCompat.checkSelfPermission(PainterActivity.this, Manifest.permission.CALL_PHONE);
