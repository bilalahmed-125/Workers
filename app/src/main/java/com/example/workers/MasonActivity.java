...
public class MasonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = fb.collection("workers").whereEqualTo("profession","Mason");
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            images.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    int checkPermission = ContextCompat.checkSelfPermission(MasonActivity.this, Manifest.permission.CALL_PHONE);
